...
interface ElectronAPI {
  ...
  setRemoteUploadAuth: (serverUrl: string, authToken: string) => Promise<{success: boolean; error?: string}>;
  setRemoteInboxAuthToken: (authToken: string) => Promise<{success: boolean; error?: string}>;
  sendVideoToRemoteServerAuth: (serverUrl: string, filePath: string, displayName: any, authToken: string) => Promise<{success: boolean; jobId?: string; error?: string}>;
  getRemoteJobStatus: (serverUrl: string, jobId: string, authToken?: string) => Promise<{success: boolean; data?: any; error?: string; detail?: any}>;
  getRemoteJobResult: (serverUrl: string, jobId: string, authToken?: string) => Promise<{success: boolean; data?: any; error?: string; detail?: any}>;
  getRemoteJobTranscript: (serverUrl: string, jobId: string, authToken?: string) => Promise<{success: boolean; data?: any; error?: string; detail?: any}>;
  remoteLibraryList: (serverUrl: string, authToken: string) => Promise<{success: boolean; data?: any; error?: string; detail?: any}>;
  remoteLibraryMeta: (serverUrl: string, lectureId: string, authToken: string) => Promise<{success: boolean; data?: any; error?: string; detail?: any}>;
  remoteLibraryWords: (serverUrl: string, lectureId: string, authToken: string) => Promise<{success: boolean; data?: any; error?: string; detail?: any}>;
  remoteYouTubeIngest: (serverUrl: string, url: string, jobId: string | null, authToken: string) => Promise<{success: boolean; data?: any; error?: string; detail?: any}>;
